  ...
  return (
    <div className="max-w-6xl mx-auto p-6 mt-12">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        {/* utm_source */}
        <div className="bg-[#16213e] rounded-lg p-6 border border-gray-700">
          ...
          <div className="bg-[#0f1419] p-4 rounded border border-gray-700">
        ...
        {/* utm_content */}
        <div className="bg-[#16213e] rounded-lg p-6 border border-gray-700 md:col-span-2">
          <div className="flex items-start gap-3 mb-3">
            <span className="bg-gray-600 text-white px-3 py-1 rounded text-sm font-semibold">
              선택
            </span>
      ...
      {/* 실제 사용 예시 */}
      <div className="bg-[#16213e] rounded-lg p-8 border border-gray-700 mb-12">
        ...
        <div className="bg-[#0f1419] p-4 rounded border border-gray-700 overflow-x-auto">
      ...
      {/* 베스트 프랙티스 */}
      <div className="bg-[#16213e] rounded-lg p-8 border border-gray-700">
        <h3 className="text-2xl font-bold text-white mb-4">
        ...
        <ul className="space-y-3 text-gray-300">
          <li className="flex items-start gap-3">
            ...
            <span>
              ...
              <code className="bg-[#0f1419] px-2 py-1 rounded text-green-400">
                utm_source=google
              </code>
            </span>
          </li>
